...
public class PublicConstant {
    ...
    public static final String EDIT_FAIL = "修改数据失败";

    public static final String REMOVE_FAIL = "删除数据失败";
    ...
    public static final String INVALID_PARAM = "参数不能为空";

    public static final String INVALID_USER_EXIST  = "用户已存在";

    public static final String INVALID_RECHANGE = "该充值记录不存在";

    public static final String INVALID_ROLE  = "角色不存在";

    public static final String ROLE_USER_USED  = "角色使用中，不可删除";

    public static final String INVALID_ADDRESS = "当前地区没有数据";

    public static final String INVALID_AUTHRIZATION = "该认证信息不存在";
    ...
    public static final String REPEAT_AUTHRIZATION = "7天之内不得重复认证";
